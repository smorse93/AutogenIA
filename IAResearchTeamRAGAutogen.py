...
groupchat = autogen.GroupChat(agents=[user_proxy, planner, critic, userexperiencemanager, profitmanager, brandmanager, capabilitiesmanager, partnersmanager, channelmanager, offeringsmanager], messages=[], max_round=50)
...
messageRequest = """You are a consulting firm working with your client: Nike. Your job is to create 3 completely new, innovative and unexpected digital products that millions of athletes would find desirable. Each must fit inside of a new app 
